-- Apaga tabelas antigas se existirem, para garantir uma recriação limpa
DROP TABLE IF EXISTS nascimentos;
DROP TABLE IF EXISTS obitos;
DROP TABLE IF EXISTS casamentos;

-- Tabela de Nascimentos (sem alterações)
CREATE TABLE nascimentos (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    data_envio TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    nome_nascido TEXT, mae_nome TEXT, mae_naturalidade TEXT, mae_estado_civil TEXT, mae_profissao TEXT, mae_endereco TEXT, mae_cep TEXT, mae_telefone TEXT, mae_rg TEXT, mae_cpf TEXT, mae_cnh TEXT, mae_avos TEXT,
...
-- Tabela de Óbitos (sem alterações)
CREATE TABLE obitos (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    data_envio TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    falecido_nome TEXT, falecido_dt_nasc TEXT, falecido_naturalidade TEXT, falecido_estado_civil TEXT, falecido_conjuge TEXT, falecido_profissao TEXT, falecido_rg TEXT, falecido_cpf TEXT, falecido_cnh TEXT, falecido_pais TEXT, falecido_endereco TEXT,
...
-- Tabela de Casamentos (ESTRUTURA FINAL)
CREATE TABLE casamentos (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    data_envio TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    noivo1_nome TEXT, noivo1_cpf TEXT, noivo1_rg TEXT, noivo1_cnh TEXT, noivo1_dt_nasc TEXT, noivo1_profissao TEXT, noivo1_naturalidade TEXT, noivo1_estado_civil TEXT, noivo1_endereco TEXT, noivo1_pai TEXT, noivo1_mae TEXT, noivo1_nome_futuro TEXT,
    ...
    arquivos_noivo1_id TEXT, arquivos_noivo1_end TEXT,
    arquivos_noivo2_id TEXT, arquivos_noivo2_end TEXT,
    arquivos_test1_id TEXT,
    arquivos_test1_end TEXT, -- NOVO
    arquivos_test2_id TEXT,
    arquivos_test2_end TEXT  -- NOVO
);